...
public class LongestSubstringWithoutRepeatingCharacters {
  ...
  /**
   * Fast and Slow pointer sliding window
   * Time complexity: O(N) as it iterates and builds the Set
   * Space complexity: O(N) as the Set grows according to the length of input string S
   * @param s
   * @return
   */
